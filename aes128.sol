...
contract AES128 {
    ...
    function dec (uint8[16] memory cipher, uint8[16] memory key) public view returns (uint8 [16] memory) {
    ...
    function rot_word (uint8[4] w) private pure returns (uint8[4] memory) {
